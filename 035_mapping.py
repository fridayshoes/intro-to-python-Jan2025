...
def add_one_hundred_to_numbers(numbers):
  plus_100_list = [] # This is the new list

  for number in numbers: # We go throuhg each number
    new_number = number + 100 # We add 100 to create a new number
    plus_100_list.append(new_number) # We append it in a new list

  return plus_100_list
