...
def count_words_by_length(words):
  word_length_accumultor = {}
  
  for word in words:
    wordlength = len(word)
    print(wordlength)
    if wordlength not in word_length_accumultor:
      word_length_accumultor[wordlength] = 1

    else:
      word_length_accumultor[wordlength] = word_length_accumultor[wordlength] + 1

  return word_length_accumultor
